...
import cryptozhiest from '../images/cryptozhiest.jpg';

const marketData = [
  {
    name: 'Coinbase',
    description: 'OKX - это крупная криптовалютная биржа, предоставляющая множество торговых возможностей и имеющая высокий уровень ликвидности.',
    image: okx,
